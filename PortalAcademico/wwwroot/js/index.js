// ==========================================
// INDEX.JS - COMPLETO COM PERFIL E ENGRENAGENS
// ==========================================
    ...
    biomedicina: [
        ...
        { period: "2º Período: Ciclo Biológico", desc: "Funcionamento orgânico", subjects: [
            { id: "bio3", icon: "🫀", name: "Fisiologia Humana", hours: "270h", trilha: [
                ...
                { 
                    ...
                    desc: `
                        <strong>Biologia 2º ano</strong><br>
                        • Coraçãos<br>
                        • Grande e Pequena Circulação<br>
                        • Vasos<br>
                        <br>
                    ` 
                },
                { 
                    ...
                    desc: `
                        <strong>Biologia 2º ano</strong><br>
                        • Hematose<br>
                        • Transporte de Gases<br>
                        • Mecânica Respiratória<br>
                        • Controle do pH Sanguíneo<br>
                        <br>
                    ` 
                },
                { 
                ...
                { 
                    tipo: "faculdade", 
                    titulo: "Fisiologia Renal", 
                    desc: `
                        <strong>Fisiologia I 2º Período</strong><br>
                        • Mecanismo de Contracorrente<br>
                ...
                { 
                    ...
                    desc: `
                        <strong>Fisiologia II 3º Período</strong><br>
                        • Potencial de Repouso e Potencial de Ação<br>
                        • Sinapses Químicas<br>
            ...
            { id: "bio4", icon: "🦠", name: "Microbiologia", hours: "270h", trilha: [
                ...
                { 
                    tipo: "faculdade", 
                    titulo: "Genética Bacteriana e Resistência a Antibióticos", 
                    desc: `
                        <strong>Microbiologia Geral 2º periodo</strong><br>
                        • Plasmídeos<br>
                        • Transferência Horizontal de Genes<br>
                ...
                { 
                    tipo: "faculdade", 
                    titulo: "Curva de Crescimento e Metabolismo Microbiano", 
                    desc: `
                        <strong>Microbiologia Médica 4º periodo</strong><br>
                        • Fases do Crescimento<br>
                        • Meios de Cultura<br>
                        • Controle Microbiano<br>
                        <br>
                    ` 
                },
            ]}
        ...
        { period: "3º Período: Genética e Defesa", desc: "DNA e Imunidade", subjects: [
            { id: "bio5", icon: "🧬", name: "Genética Humana", hours: "240h", trilha: [
                { 
                    tipo: "base", 
                    titulo: "Sistema ABO e Fator Rh (Polialelia e Codominância)", 
                    desc: `
                        <strong>Biologia 3º ano</strong><br>
                        • Codominância<br>
                        • Relação de Dominância<br>
                        • Transfusões Sanguíneas<br>
                ...
                { 
                    tipo: "base", 
                    titulo: "Herança Ligada ao Sexo (Herança Gonossômica)", 
                    desc: `
                        <strong>Biologia 3º ano</strong><br>
                        • Herança Recessiva Ligada ao X<br>
                ...
                { 
                    ...
                    titulo: "Epigenética", 
                    desc: `
                        <strong>Genética Médica 3º periodo</strong><br>
                        • Metilação do DNA<br>
                        • Modificações de Histonas<br>
                        • RNAs não-codificantes<br>
                        • Influência Ambiental e Programação Fetal<br>
                        <br>
                    ` 
                },
            ]},
            { id: "bio6", icon: "🛡️", name: "Imunologia Básica", hours: "240h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Biologia 2º ano</strong><br>
                        • Imunização Ativa Natural<br>
                        • Imunização Ativa Artificial<br>
                ...
                { 
                    tipo: "faculdade", 
                    titulo: "Estrutura e Genética do MHC", 
                    desc: `
                        <strong>Imunologia Celular 3º periodo</strong><br>
                        • MHC de Classe I<br>
                        • MHC de Classe II<br>
                        • Polimorfismo e Poligenia<br>
                        <br>
                    ` 
                },
            ]}
    ...
    civil: [
        { period: "1º Período: Ciclo Básico", desc: "Matemática e Física", subjects: [
            { id: "civ1", icon: "📐", name: "Cálculo Diferencial I", hours: "225h", trilha: [
                { 
                    ...
                    titulo: "Funções", 
                    desc: `
                        <strong>Matemática 1º ano</strong><br>
                        • Conceitos Básicos<br>
                        • Função Afim (1º Grau)<br>
                        • Função Quadrática (2º Grau)<br>
                        • Função Exponencial<br>
                        • Função Logarítmica (2º Grau)<br>
                ...
                { 
                    ...
                    desc: `
                        <strong>Matemática 2º ano</strong><br>
                        • Trigonometria no Triângulo Retângulo<br>
                        • Ciclo Trigonométrico<br>
                        • Sinais nos Quadrantes<br>
                        • Gráficos Trigonométricos<br>
                        • Identidades Trigonométricas<br>
                        • Transformações e Arcos Duplos<br>
                        <br>
                    ` 
                },
                { 
                    ...
                    titulo: "Limites", 
                    desc: `
                        <strong>Cálculo Diferencial e Integral I 1º periodo</strong><br>
                        • Ideia Intuitiva e Definição Formal<br>
                        • Limites Laterais<br>
                        • Propriedades dos Limites<br>
                        • Indeterminações Matemáticas<br>
                        • Limites no Infinito e Limites Infinitos<br>
                        • Limites Fundamentais<br>
                        • Continuidade<br>
                        <br>
                    ` 
                },
                { 
                    ...
                    desc: `
                        <strong>Cálculo Diferencial e Integral I 1º periodo</strong><br>
                        • MDefinição de Derivada por Limite<br>
                        • Regras Básicas de Derivação<br>
                        • Regra do Produto e do Quociente<br>
                        • Regra da Cadeia<br>
                        • Derivadas de Funções Transcendentes<br>
                        • Derivação Implícita<br>
                        • Regra de L'Hôpitalbr>
                        <br>
                    ` 
                },
            ]},
            { id: "civ2", icon: "⚙️", name: "Física Geral I", hours: "225h", trilha: [
                { 
                    ...
                    titulo: "Dinâmica", 
                    desc: `
                        <strong>Física 1º ano</strong><br>
                        • As Três Leis de Newton<br>
                        • Tipos de Forças<br>
                        • Trabalho e Energia<br>
                        • Impulso e Quantidade de Movimento<br>
                        • Dinâmica do Movimento Circular<br>
                        <br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    titulo: "Dinâmica do Corpo Rígido", 
                    desc: `
                        <strong>Mecânica Clássica 1º periodo</strong><br>
                        • Cinemática Rotacional<br>
                        • Torque<br>
                        • Momento de Inércia<br>
                        • A Segunda Lei de Newton para Rotações<br>
                        • Rolamento<br>
                        • Momento Angular e sua Conservação<br>
                        <br>
                    ` 
                },
            ]}
        ...
        { period: "2º Período: Avançando nas Exatas", desc: "Mais Cálculos", subjects: [
            { id: "civ3", icon: "📈", name: "Cálculo Integral II", hours: "225h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Matemática 2º ano</strong><br>
                        • Geometria de Posição<br>
                        • Poliedros e a Relação de Euler<br>
                        • Prismas e Paralelepípedos<br>
                        • Pirâmides<br>
                        • Corpos Redondos<br>
                        • Troncos<br>
                        <br>
                ...
                { 
                    ...
                    desc: `
                        <strong>Cálculo Vetorial 2º periodo</strong><br>
                        • Integrais Duplas<br>
                        • Aplicações de Integrais Duplas<br>
            ...
            { id: "civ4", icon: "🌡️", name: "Física Geral II", hours: "225h", trilha: [
                ...
                { 
                    ...
                    desc: `
                        <strong>Termodinâmica 3º periodo</strong><br>
                        • A Lei Zero<br>
                        • A Primeira Lei da Termodinâmica<br>
                        • Teoria Cinética dos Gases<br>
                        • Máquinas Térmicas e Refrigeradores<br>
        ...
        { period: "3º Período: Engenharia Aplicada", desc: "Entrando na Profissão", subjects: [
            { id: "civ5", icon: "🏗️", name: "Resistência dos Materiais", hours: "270h", trilha: [
                { 
                    ...
                    desc: `
                        ...
                        • Associação de Molas<br>
                        • Energia Potencial Elástica<br>
                        • Trabalho da Força Elástica<br>
                        <br>
                    ` 
                },
                { 
                    ...
                    titulo: "Tensão", 
                    desc: `
                        <strong>Mecânica dos Sólidos 3º periodo</strong><br>
                        • Tensão Normal<br>
                        • Tensão de Cisalhamento<br>
                        • O Diagrama Tensão-Deformação<br>
                        • Lei de Hooke Generalizada<br>
                        • Coeficiente de Poisson<br>
                        • Tensão Admissível e Fator de Segurança<br>
                        <br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    titulo: "Diagramas de Esforços em Vigas", 
                    desc: `
                        <strong>Mecânica dos Sólidos 4º periodo</strong><br>
                        • Tipos de Apoios<br>
                        • Cálculo das Reações de Apoio<br>
                        • Diagrama de Esforço Normal<br>
                        • Diagrama de Esforço Cortante<br>
                        • Diagrama de Momento Fletor<br>
                        • Relações Diferenciais<br>
                        • Método das Seções<br>
                        <br>
                    ` 
                },
            ]},
            { id: "civ6", icon: "🖥️", name: "Desenho Técnico", hours: "240h", trilha: [
                { 
                    tipo: "base", 
                    titulo: "Projeções Ortogonais", 
                    desc: `
                        <strong>Matemática 2º ano</strong><br>
                        • O Método de Monge<br>
                        • Os Diedros<br>
                        • As Seis Vistas Principais<br>
                        • Linhas Visíveis e Ocultas<br>
                ...
                { 
                    ...
                    titulo: "Cortes", 
                    desc: `
                        <strong>Expressão Gráfica 1º periodo</strong><br>
                        • Planos de Corte<br>
                        • Hachuras<br>
                        • Corte Total<br>
                        • Meio-Corte<br>
        ...
        { period: "1º Período: Fundamentos", desc: "Introdução aos negócios", subjects: [
            { id: "cont1", icon: "📈", name: "Matemática Financeira", hours: "225h", trilha: [
               { 
                    ...
                    desc: `
                        ...
                        • Juros Simples vs Juros Compostos<br>
                        • Fórmula do Montante<br>
                        • Taxas Equivalentes<br>
                        • Desconto Composto<br>
                        • Inflação e Taxa Real<br>
                        <br>
                    ` 
                },
                { 
                    ...
                    desc: `
                        <strong>Matemática 1º ano</strong><br>
                        • Definição e Razão<br>
                        • Classificação das PGs<br>
                        • Fórmula do Termo Geral<br>
                        • Soma dos Termos de uma PG Finita<br>
                        • Soma dos Termos de uma PG Infinita<br>
                ...
                { 
                    ...
                    desc: `
                        <strong>Administração Financeira 3º periodo</strong><br>
                        • O Valor do Dinheiro no Tempo<br>
                        • Fluxo de Caixa<br>
                        • Taxa Mínima de Atratividade<br>
                        • Payback Simples e Descontado<br>
                        • Valor Presente Líquido<br>
                        • Taxa Interna de Retorno<br>
                        • Comparação de Projetos<br>
                        • Seções<br>
                        <br>
                    ` 
                },
            ...
            { id: "cont2", icon: "📘", name: "Contabilidade Introdutória", hours: "225h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Educação Financeira 1º ano</strong><br>
                        • Mapeamento de Receitas<br>
                        • Classificação de Despesas<br>
                        • Fluxo de Caixa Pessoal<br>
                        • Regra 50-30-20<br>
                ...
                { 
                    tipo: "faculdade", 
                    titulo: "Estruturação do Balanço Patrimonial", 
                    desc: `
                        <strong>Contabilidade Geral 2º periodo</strong><br>
                        ...
                        • Plano de Contas<br>
                        • Grau de Liquidez e Exigibilidade<br>
                        <br>
                    ` 
                },
            ]}
        ...
        { period: "2º Período: Intermediário", desc: "Aprofundando os registros", subjects: [
            { id: "cont3", icon: "📊", name: "Contabilidade Intermediária", hours: "270h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Português 2º e 3º ano</strong><br>
                        • Leitura Crítica e Compreensão<br>
                        • Análise de Textos Técnicos<br>
                        • Sintaxe e Coesão<br>
                        • Atenção a detalhes corporativos<br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    ...
                    desc: `
                        <strong>Contabilidade Intermediária 3º Período</strong><br>
                        • Receitas Operacionais e Deduções<br>
                        • Custo da Mercadoria Vendida (CMV)<br>
                        • Despesas Operacionais e Não Operacionais<br>
                        • Apuração do Lucro ou Prejuízo Líquido<br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    ...
                    desc: `
                        <strong>Contabilidade Intermediária 4º Período</strong><br>
                        • Atividades Operacionais<br>
                        • Atividades de Investimento<br>
                        • Atividades de Financiamento<br>
                        • Método Direto vs Método Indireto<br>
                    ` 
                }
            ]},
            { id: "cont4", icon: "⚖️", name: "Direito Empresarial", hours: "240h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Sociologia 1º e 2º ano</strong><br>
                        • Direitos do Cidadão<br>
                        • Noções Básicas de Contratos<br>
                        • Código de Defesa do Consumidor<br>
                        • Deveres Civis e Ética<br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    titulo: "Tipos de Sociedade", 
                    desc: `
                        <strong>Direito Empresarial 3º Período</strong><br>
                        • Sociedade Limitada (LTDA)<br>
                        • Sociedade Anônima (S.A.)<br>
                        • Microempreendedor Individual (MEI)<br>
                        • Contrato Social e Estatuto<br>
                        • Falência e Recuperação Judicial<br>
                    ` 
                }
            ]}
        ]},
        { period: "3º Período: Tributos e Custos", desc: "A Realidade do Mercado", subjects: [
            { id: "cont5", icon: "🏛️", name: "Legislação Tributária", hours: "270h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Sociologia e Geografia 3º ano</strong><br>
                        • O Papel do Estado e Arrecadação<br>
                        • Retorno Social dos Impostos<br>
                        • Carga Tributária no Brasil<br>
                        • Sonegação vs Elisão Fiscal<br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    titulo: "Impostos Diretos e Indiretos", 
                    desc: `
                        <strong>Direito Tributário 4º Período</strong><br>
                        • Simples Nacional, Lucro Presumido e Real<br>
                        • Impostos Federais (PIS, COFINS, IRPJ, CSLL)<br>
                        • Impostos Estaduais (ICMS)<br>
                        • Impostos Municipais (ISS)<br>
            ...
            { id: "cont6", icon: "💰", name: "Contabilidade de Custos", hours: "240h", trilha: [
                { 
                    ...
                    desc: `
                        <strong>Matemática 1º e 2º ano</strong><br>
                        • Operações Fundamentais<br>
                        • Regra de Três Simples e Composta<br>
                        • Porcentagem e Proporção<br>
                        • Leitura de Planilhas e Tabelas<br>
                    ` 
                },
                { 
                    tipo: "faculdade", 
                    ...
                    desc: `
                        <strong>Contabilidade de Custos 5º Período</strong><br>
                        • Diferença entre Custos e Despesas<br>
                        • Custos Diretos e Indiretos<br>
                        • Rateio de Custos Indiretos (CIF)<br>
 ...
 administracao: [
    { period: "1º Período: Fundamentos da Gestão", desc: "Introdução à administração", subjects: [
        { id: "adm1", icon: "🏢", name: "Teoria Geral da Administração", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "Capitalismo e Burocracia", 
                desc: `
                    <strong>História 2º e 3º ano</strong><br>
                    • Revoluções Industriais (1ª, 2ª e 3ª)<br>
                    • Modelos de Produção (Fordismo, Toyotismo)<br>
                    • Crise de 1929 e Neoliberalismo<br>
                    <br>
                    <strong>Sociologia 2º ano</strong><br>
                    • Max Weber e o Modelo Burocrático<br>
                    • Karl Marx e as Relações de Trabalho<br>
                    • Hierarquia e Divisão do Trabalho<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Escolas Administrativas", 
                desc: `
                    <strong>TGA 1º Período</strong><br>
                    • Escola Científica (Frederick Taylor)<br>
                    • Escola Clássica (Henry Fayol)<br>
                    • Escola das Relações Humanas (Elton Mayo)<br>
                    • Teoria Sistêmica e Contingencial<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Processo Organizacional", 
                desc: `
                    <strong>TGA 2º Período</strong><br>
                    • O Ciclo PODC: Planejar, Organizar, Dirigir e Controlar<br>
                    • Desenho Organizacional (Organogramas)<br>
                    • Níveis: Estratégico, Tático e Operacional<br>
                    • Cultura e Clima Organizacional<br>
                ` 
            }
        ]},
        { id: "adm2", icon: "📊", name: "Estatística Aplicada", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "Estatística Básica e Probabilidade", 
                desc: `
                    <strong>Matemática 2º ano</strong><br>
                    • Análise Combinatória e Fatorial<br>
                    • Conceitos de Probabilidade<br>
                    <br>
                    <strong>Matemática 3º ano</strong><br>
                    • Estatística Descritiva (Média, Moda, Mediana)<br>
                    • Medidas de Dispersão (Desvio Padrão, Variância)<br>
                    • Leitura e Interpretação de Gráficos e Tabelas<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Probabilidade Aplicada", 
                desc: `
                    <strong>Estatística I 2º Período</strong><br>
                    • Teorema de Bayes<br>
                    • Distribuição de Probabilidade Discreta (Binomial)<br>
                    • Distribuição Contínua (Curva Normal)<br>
                    • Teorema Central do Limite<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Inferência e Amostragem", 
                desc: `
                    <strong>Estatística II 3º Período</strong><br>
                    • Técnicas de Amostragem<br>
                    • Intervalos de Confiança<br>
                    • Teste de Hipóteses para Tomada de Decisão<br>
                    • Correlação e Regressão Linear Simples<br>
                ` 
            }
        ]}
    ]},
    { period: "2º Período: Gestão de Pessoas e Mercado", desc: "RH e Marketing", subjects: [
        { id: "adm3", icon: "👥", name: "Gestão de Pessoas", hours: "270h", trilha: [
            { 
                tipo: "base", 
                titulo: "Comportamento e Comunicação", 
                desc: `
                    <strong>Filosofia 2º ano</strong><br>
                    • Ética Moral nas Relações Humanas<br>
                    • Inteligência Emocional e Resolução de Conflitos<br>
                    <br>
                    <strong>Português 2º e 3º ano</strong><br>
                    • Comunicação Assertiva e Feedback<br>
                    • Interpretação e Redação Corporativa<br>
                    • Oratória e Apresentação em Público<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Subsistemas de RH", 
                desc: `
                    <strong>Gestão de RH 3º Período</strong><br>
                    • Atração e Retenção de Talentos<br>
                    • Recrutamento e Seleção (Entrevistas por Competência)<br>
                    • Cargos e Salários (Remuneração Estratégica)<br>
                    • Avaliação de Desempenho<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Treinamento e Liderança", 
                desc: `
                    <strong>Comportamento Organizacional 4º Período</strong><br>
                    • Levantamento de Necessidades de Treinamento (LNT)<br>
                    • Estilos de Liderança (Autocrática, Democrática, Situacional)<br>
                    • Teorias de Motivação (Maslow, Herzberg, McClelland)<br>
                    • Gestão da Mudança Organizacional<br>
                ` 
            }
        ]},
        { id: "adm4", icon: "💰", name: "Gestão de Marketing", hours: "240h", trilha: [
            { 
                tipo: "base", 
                titulo: "Geopolítica e Consumo", 
                desc: `
                    <strong>Geografia 3º ano</strong><br>
                    • Redes de Comunicação e Globalização<br>
                    • Sociedade de Consumo e Indústria Cultural<br>
                    <br>
                    <strong>Arte e Linguagens 2º ano</strong><br>
                    • Semiótica (Estudo dos Signos e Logotipos)<br>
                    • Funções da Linguagem na Publicidade (Função Apelativa)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Fundamentos e Mix de Marketing", 
                desc: `
                    <strong>Marketing I 3º Período</strong><br>
                    • O Comportamento do Consumidor<br>
                    • Os 4 Ps (Produto, Preço, Praça e Promoção)<br>
                    • Ciclo de Vida do Produto<br>
                    • Canais de Distribuição e Logística<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Marketing II 4º Período</strong><br>
                    • Segmentação de Mercado e Público-Alvo (Persona)<br>
                    • Posicionamento de Marca (Branding)<br>
                    • Pesquisa de Mercado (Qualitativa e Quantitativa)<br>
                    • Marketing Digital e Inbound Marketing<br>
                ` 
            }
        ]}
    ]},
    { period: "3º Período: Estratégia e Finanças", desc: "Planejamento estrutural", subjects: [
        { id: "adm5", icon: "🎯", name: "Planejamento Estratégico", hours: "270h", trilha: [
            { 
                ...
                desc: `
                    <strong>Geografia 3º ano</strong><br>
                    • Blocos Econômicos (Mercosul, UE)<br>
                    • Dinâmica do Comércio Internacional<br>
                    <br>
                    <strong>Filosofia e Sociologia 3º ano</strong><br>
                    • Racionalidade Limitada e Tomada de Decisão<br>
                    • Responsabilidade Social Corporativa (ESG)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Diretrizes e Diagnóstico", 
                desc: `
                    <strong>Planejamento Estratégico 5º Período</strong><br>
                    • Identidade Organizacional (Missão, Visão e Valores)<br>
                    • Análise do Ambiente Externo (Matriz PESTEL)<br>
                    • Análise do Ambiente Interno e Externo (Matriz SWOT/FOFA)<br>
                    • As 5 Forças Competitivas de Michael Porter<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Gestão Estratégica 6º Período</strong><br>
                    • Matriz BCG (Estrela, Vaca Leiteira, Abacaxi)<br>
                    • Balanced Scorecard (BSC) e Mapas Estratégicos<br>
                    • Indicadores Chave de Desempenho (KPIs)<br>
                    • Metodologia OKR (Objectives and Key Results)<br>
                ` 
            }
        ]},
        { id: "adm6", icon: "📈", name: "Administração Financeira", hours: "240h", trilha: [
            { 
                ...
                desc: `
                    <strong>Matemática 1º e 2º ano</strong><br>
                    • Porcentagem e Proporção<br>
                    • Funções Exponenciais (Crescimento de Capital)<br>
                    • Juros Simples e Juros Compostos<br>
                    • Descontos e Séries Uniformes de Pagamento<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Análise de Investimentos", 
                desc: `
                    <strong>Finanças I 4º Período</strong><br>
                    • Custo de Oportunidade e Valor do Dinheiro no Tempo<br>
            ...
            { 
                ...
                desc: `
                    <strong>Finanças II 5º Período</strong><br>
                    • Análise de Balanço Patrimonial e DRE<br>
                    • Gestão do Capital de Giro<br>
                    • Alavancagem Operacional e Financeira<br>
                    • Estrutura de Capital e Custos de Financiamento<br>
                ` 
            }
        ]}
    ]}
...
direito: [
    { period: "1º Período: Introdução ao Direito", desc: "Fundamentos jurídicos", subjects: [
        { id: "dir1", icon: "⚖️", name: "Introdução e Teoria do Direito", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "Filosofia Política e Contratualistas", 
                desc: `
                    <strong>Filosofia 1º e 2º ano</strong><br>
                    • O conceito de Justiça em Platão e Aristóteles<br>
                    • Ética, Moral e Liberdade<br>
                    <br>
                    <strong>Sociologia 2º ano</strong><br>
                    • Contratualistas (Hobbes, Locke, Rousseau)<br>
                    • A formação do Estado e o Monopólio da Força (Weber)<br>
                    • Cidadania e Direitos Sociais<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Fontes e Ramos do Direito", 
                desc: `
                    <strong>Introdução ao Estudo do Direito 1º Período</strong><br>
                    • Direito Público vs Direito Privado<br>
                    • Direito Natural (Jusnaturalismo) vs Positivo (Juspositivismo)<br>
                    • Fontes Formais (Lei, Costumes)<br>
                    • Fontes Materiais (Doutrina, Jurisprudência)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "A Norma Jurídica", 
                desc: `
                    <strong>Teoria Geral do Direito 2º Período</strong><br>
                    • Vigência, Validade e Eficácia da Lei<br>
                    • Hermenêutica (Interpretação das Normas)<br>
                    • Integração do Direito (Analogia, Princípios Gerais)<br>
                    • Antinomias Jurídicas (Conflito entre Leis)<br>
                ` 
            }
        ]},
        { id: "dir2", icon: "📜", name: "Direito Constitucional", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "História das Constituições Brasileiras", 
                desc: `
                    <strong>História 3º ano</strong><br>
                    • Constituição Outorgada de 1824 (Poder Moderador)<br>
                    • A Era Vargas e a Constituição de 1934/1937<br>
                    • O Regime Militar (1964) e AI-5<br>
                    • Redemocratização e a Constituição Cidadã (1988)<br>
                    <br>
                    <strong>Sociologia 3º ano</strong><br>
            ...
            { 
                ...
                desc: `
                    <strong>Direito Constitucional I 2º Período</strong><br>
                    • Poder Constituinte (Originário e Derivado)<br>
                    • Princípios Fundamentais do Estado Brasileiro<br>
                    • Direitos e Garantias Individuais (Art. 5º da CF)<br>
                    • Remédios Constitucionais (Habeas Corpus, Mandado de Segurança)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Direito Constitucional II 3º Período</strong><br>
                    • Repartição de Competências (União, Estados, Municípios)<br>
                    • Poder Executivo, Legislativo e Judiciário<br>
                    • Processo Legislativo (Como nasce uma lei)<br>
                    • Controle de Constitucionalidade (STF, ADI, ADC, ADPF)<br>
                ` 
            }
        ]}
    ]},
    { period: "2º Período: Relações Civis e Privadas", desc: "O dia a dia jurídico", subjects: [
        { id: "dir3", icon: "📝", name: "Direito Civil - Parte Geral", hours: "270h", trilha: [
            { 
                tipo: "base", 
                titulo: "O Indivíduo e a Sociedade", 
                desc: `
                    <strong>Filosofia 2º ano</strong><br>
                    • O Sujeito de Direitos e a Autonomia Privada<br>
                    • O conceito de Dignidade da Pessoa Humana<br>
                    <br>
                    <strong>Sociologia 1º e 2º ano</strong><br>
                    • A Família como Instituição Social<br>
                    • O conceito de Propriedade Privada<br>
                    • A Função Social das Instituições<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Pessoas Físicas e Jurídicas", 
                desc: `
                    <strong>Direito Civil I 3º Período</strong><br>
                    • Início da Personalidade e Nascituro<br>
                    • Capacidade Civil (Absoluta e Relativa) e Emancipação<br>
                    • Direitos da Personalidade (Imagem, Honra, Nome)<br>
                    • Pessoas Jurídicas (Fundações, Associações)<br>
                    • Desconsideração da Personalidade Jurídica<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Bens e Negócios Jurídicos", 
                desc: `
                    <strong>Direito Civil II 4º Período</strong><br>
                    • Classificação dos Bens (Móveis, Imóveis, Fungíveis)<br>
                    • Fato, Ato e Negócio Jurídico<br>
                    • Elementos de Validade (Agente Capaz, Objeto Lícito)<br>
                    • Defeitos do Negócio (Erro, Dolo, Coação, Fraude)<br>
                    • Nulidade Absoluta x Anulabilidade<br>
                ` 
            }
        ]},
        { id: "dir4", icon: "🏠", name: "Direito das Obrigações", hours: "240h", trilha: [
            { 
                tipo: "base", 
                titulo: "Educação Financeira e Lógica", 
                desc: `
                    <strong>Educação Financeira (Matemática) 2º ano</strong><br>
                    • Leitura de Contratos Básicos e Juros Abusivos<br>
                    • Cheques, Promissórias e Garantias<br>
                    <br>
                    <strong>Filosofia 3º ano</strong><br>
                    • Causalidade e Responsabilidade<br>
                    • Boa-fé e Ação Moral<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Direito Civil III 4º Período</strong><br>
                    • Elementos da Obrigação (Credor, Devedor, Objeto)<br>
                    • Obrigações de Dar (Coisa Certa e Incerta)<br>
                    • Obrigações de Fazer e Não Fazer<br>
                    • Obrigações Solidárias e Alternativas<br>
                    • Transmissão das Obrigações (Cessão de Crédito)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Adimplemento e Inadimplemento", 
                desc: `
                    <strong>Direito Civil IV 5º Período</strong><br>
                    • Formas de Pagamento e Consignação<br>
                    • Inadimplemento Absoluto vs Mora<br>
                    • Perdas e Danos (Danos Emergentes e Lucros Cessantes)<br>
                    • Cláusula Penal (Multa) e Arras (Sinal)<br>
                    • Juros Legais e Correção Monetária<br>
                ` 
            }
        ]}
    ]},
    { period: "3º Período: Sistema Penal e Processual", desc: "Punição e tramitação", subjects: [
        { id: "dir5", icon: "🔒", name: "Direito Penal", hours: "270h", trilha: [
            { 
                tipo: "base", 
                titulo: "Violência e Controle Social", 
                desc: `
                    <strong>Sociologia 3º ano</strong><br>
                    • Michel Foucault: Vigiar e Punir (Sistema Carcerário)<br>
                    • Desigualdade Social e Criminalidade<br>
                    • Violência Simbólica e Física<br>
                    <br>
                    <strong>Filosofia 2º ano</strong><br>
                    • Imputabilidade (Livre-arbítrio e Consciência)<br>
                    • Legítima Defesa e Sobrevivência<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Direito Penal I 3º Período</strong><br>
                    • Fato Típico (Conduta, Resultado, Nexo Causal e Tipicidade)<br>
                    • Ilicitude (Legítima Defesa, Estado de Necessidade)<br>
                    • Culpabilidade (Imputabilidade, Exigibilidade de Conduta)<br>
                    • Erro de Tipo e Erro de Proibição<br>
                    • Tentativa e Consumação<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Teoria da Pena", 
                desc: `
                    <strong>Direito Penal II 4º Período</strong><br>
                    • Penas Privativas de Liberdade (Reclusão e Detenção)<br>
                    • Penas Restritivas de Direitos e Multa<br>
                    • Dosimetria da Pena (Como o juiz calcula o tempo)<br>
                    • Concurso de Pessoas e Concurso de Crimes<br>
                    • Suspensão Condicional da Pena (Sursis)<br>
                ` 
            }
        ]},
        { id: "dir6", icon: "⚙️", name: "Direito Processual Civil", hours: "240h", trilha: [
            { 
                tipo: "base", 
                titulo: "Argumentação e Retórica", 
                desc: `
                    <strong>Português / Redação 3º ano</strong><br>
                    • Texto Dissertativo-Argumentativo<br>
                    • Coesão, Coerência e Persuasão<br>
                    <br>
                    <strong>Filosofia 2º ano</strong><br>
                    • Lógica Formal (Aristotélica) e Silogismos<br>
                    • Premissas e Conclusões (A base das sentenças judiciais)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Fase de Conhecimento", 
                desc: `
                    <strong>Processo Civil I 4º Período</strong><br>
                    • A Petição Inicial (Requisitos, Pedido, Valor da Causa)<br>
                    • Citação e Resposta do Réu (Contestação, Reconvenção)<br>
                    • Audiência de Conciliação e Mediação<br>
                    • Fase Instrutória (Provas Documentais, Periciais e Testemunhais)<br>
                    • A Sentença Judicial<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Sistema Recursal", 
                desc: `
                    <strong>Processo Civil II 5º Período</strong><br>
                    • Teoria Geral dos Recursos<br>
                    • Recurso de Apelação<br>
                    • Agravo de Instrumento e Agravo Interno<br>
                    • Embargos de Declaração<br>
                    • Recursos aos Tribunais Superiores (REsp e RE)<br>
                ` 
            }
        ]}
    ]}
...
psicologia: [
    { period: "1º Período: Fundamentos da Psicologia", desc: "História e teorias", subjects: [
        { id: "psi1", icon: "🧠", name: "História e Matrizes da Psicologia", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "Filosofia da Mente", 
                desc: `
                    <strong>Filosofia 1º e 2º ano</strong><br>
                    • Sócrates, Platão e o conceito de Alma<br>
                    • René Descartes (Dualismo Corpo-Mente)<br>
                    • Empirismo (John Locke) vs Racionalismo<br>
                    • Fenomenologia e Existencialismo (Sartre)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "O Nascimento da Psicologia Científica", 
                desc: `
                    <strong>História da Psicologia 1º Período</strong><br>
                    • Wilhelm Wundt e o Laboratório de Leipzig<br>
                    • Estruturalismo (Edward Titchener)<br>
                    • Funcionalismo (William James)<br>
                    • A ruptura com a Filosofia<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Behaviorismo", 
                desc: `
                    <strong>Análise do Comportamento 2º Período</strong><br>
                    • Condicionamento Clássico (Ivan Pavlov)<br>
                    • Behaviorismo Metodológico (John B. Watson)<br>
                    • Behaviorismo Radical e Condicionamento Operante (B.F. Skinner)<br>
                    • Reforço, Punição e Extinção<br>
                ` 
            }
        ]},
        { id: "psi2", icon: "📚", name: "Psicologia do Desenvolvimento", hours: "225h", trilha: [
            { 
                tipo: "base", 
                titulo: "Genética, Cérebro e Sociedade", 
                desc: `
                    <strong>Biologia 3º ano</strong><br>
                    • Genética (Hereditariedade vs Ambiente)<br>
                    • Neuroplasticidade e Maturação Cerebral<br>
                    <br>
                    <strong>Sociologia 2º ano</strong><br>
                    • Socialização Primária e Secundária<br>
                    • Juventude, Identidade e Mudanças Físicas<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Psicologia do Desenvolvimento I 2º Período</strong><br>
                    • Epistemologia Genética de Jean Piaget<br>
                    • Fases: Sensório-motor, Pré-operatório, Operatório Concreto e Formal<br>
                    • Teoria Sócio-Histórica de Lev Vygotsky<br>
                    • Zona de Desenvolvimento Proximal e Linguagem<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Desenvolvimento Psicanalítico e Psicossocial", 
                desc: `
                    <strong>Psicologia do Desenvolvimento II 3º Período</strong><br>
                    • Fases Psicossexuais de Freud (Oral, Anal, Fálica, Latência, Genital)<br>
                    • Teoria Psicossocial de Erik Erikson (8 estágios da vida)<br>
                    • Teoria do Apego (John Bowlby)<br>
                    • Envelhecimento e Luto<br>
                ` 
            }
        ]}
    ]},
    { period: "2º Período: Processos Clínicos e Sociais", desc: "A mente e a sociedade", subjects: [
        { id: "psi3", icon: "😔", name: "Psicopatologia", hours: "270h", trilha: [
            { 
                tipo: "base", 
                titulo: "Neuroquímica e Saúde Coletiva", 
                desc: `
                    <strong>Biologia 2º ano</strong><br>
                    • Sinapses e Neurotransmissores (Dopamina, Serotonina)<br>
                    • Sistema Nervoso Central e Límbico (Emoções)<br>
                    <br>
                    <strong>Sociologia 3º ano</strong><br>
                    • Michel Foucault: A História da Loucura<br>
                    • O Normal e o Patológico na Sociedade<br>
                    • O Estigma Social e Luta Antimanicomial<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Semiologia Psiquiátrica", 
                desc: `
                    <strong>Psicopatologia I 3º Período</strong><br>
                    • Alterações da Consciência, Atenção e Memória<br>
                    • Alterações do Pensamento e Percepção (Alucinações)<br>
                    • Uso do DSM-5 e CID-11<br>
                    • Transtornos de Ansiedade e Fobias<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Transtornos Maiores", 
                desc: `
                    <strong>Psicopatologia II 4º Período</strong><br>
                    • Transtornos Depressivos e Bipolares<br>
                    • Esquizofrenia e Outros Transtornos Psicóticos<br>
                    • Transtornos de Personalidade (Borderline, Narcisista)<br>
                    • Transtornos do Espectro Autista (TEA) e TDAH<br>
                ` 
            }
        ]},
        { id: "psi4", icon: "🗣️", name: "Psicologia Social", hours: "240h", trilha: [
            { 
                tipo: "base", 
                titulo: "Comportamento Coletivo e Cultura", 
                desc: `
                    <strong>Sociologia 1º e 2º ano</strong><br>
                    • Instituições Sociais (Família, Escola, Estado)<br>
                    • Ideologia, Cultura e Indústria Cultural<br>
                    • Preconceito, Racismo e Desigualdade Social<br>
                    <br>
                    <strong>História 3º ano</strong><br>
                    • Movimentos de Massa e Fascismo<br>
                    • Lutas por Direitos Civis<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Psicologia Social Psicológica", 
                desc: `
                    <strong>Psicologia Social I 4º Período</strong><br>
                    • Cognição Social e Formação de Impressões<br>
                    • Experimento de Conformidade (Asch) e Obediência (Milgram)<br>
                    • Teoria da Dissonância Cognitiva (Leon Festinger)<br>
                    • Atitudes, Estereótipos e Preconceito<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Psicologia Social Crítica", 
                desc: `
                    <strong>Psicologia Social II 5º Período</strong><br>
                    • A Psicologia Social no Brasil (Silvia Lane)<br>
                    • Identidade e Consciência de Classe<br>
                    • Representações Sociais (Moscovici)<br>
                    • Intervenção em Comunidades e Políticas Públicas<br>
                ` 
            }
        ]}
    ]},
    { period: "3º Período: Terapias e Avaliação", desc: "Intervenção psicológica", subjects: [
        { id: "psi5", icon: "🛋️", name: "Psicanálise e Abordagens", hours: "270h", trilha: [
            { 
                tipo: "base", 
                titulo: "Mito, Inconsciente e Linguagem", 
                desc: `
                    <strong>Filosofia e Literatura 3º ano</strong><br>
                    • A Mitologia Grega (Complexo de Édipo)<br>
                    • O Surrealismo e a Arte do Inconsciente<br>
                    • Schopenhauer e Nietzsche (Vontade e Desejo)<br>
                    • A Crise do Sujeito Racional<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                ...
                desc: `
                    <strong>Psicanálise I 5º Período</strong><br>
                    • Sigmund Freud: A Primeira Tópica (Inconsciente, Pré-consciente, Consciente)<br>
                    • A Segunda Tópica (Id, Ego, Superego)<br>
                    • Mecanismos de Defesa (Recalque, Projeção)<br>
                    • A Interpretação dos Sonhos e Associação Livre<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Desdobramentos Clínicos", 
                desc: `
                    <strong>Teorias da Personalidade 6º Período</strong><br>
                    • Carl Jung (Inconsciente Coletivo e Arquétipos)<br>
                    • Jacques Lacan (O Estádio do Espelho e a Linguagem)<br>
                    • Abordagem Centrada na Pessoa (Carl Rogers)<br>
                    • Terapia Cognitivo-Comportamental (TCC - Aaron Beck)<br>
                ` 
            }
        ]},
        { id: "psi6", icon: "📋", name: "Avaliação Psicológica", hours: "240h", trilha: [
            { 
                tipo: "base", 
                titulo: "Estatística e Metodologia", 
                desc: `
                    <strong>Matemática 2º e 3º ano</strong><br>
                    • Estatística Descritiva (Média, Moda, Mediana)<br>
                    • Medidas de Dispersão (Desvio Padrão, Variância)<br>
                    • Leitura e Interpretação de Gráficos<br>
                    <br>
                    <strong>Metodologia Científica</strong><br>
                    • Método Científico e Hipóteses<br>
                    • Ética na Pesquisa<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Psicometria e Testes", 
                desc: `
                    <strong>Avaliação Psicológica I 5º Período</strong><br>
                    • Validade, Fidedignidade e Padronização de Testes<br>
                    • Testes de Inteligência e Cognição (WAIS, WISC)<br>
                    • Testes de Personalidade (BFP, Palográfico)<br>
                    • Testes Projetivos (Rorschach, TAT)<br>
                ` 
            },
            { 
                tipo: "faculdade", 
                titulo: "Laudos e Entrevistas", 
                desc: `
                    <strong>Avaliação Psicológica II 6º Período</strong><br>
                    • Técnicas de Entrevista Clínica (Anamnese)<br>
                    • Observação Comportamental<br>
                    • Elaboração de Documentos Psicológicos (Resolução CFP)<br>
                    • Entrevista de Devolutiva<br>
                ` 
            }
        ]}
    ]}
...
// ==========================================
// RENDERIZAÇÃO DOS CURSOS (COM BASE E FACULDADE SEPARADOS)
// ==========================================
function renderCurriculum(courseKey) {
    ...
    data.forEach((period, periodIndex) => {
        ...
        period.subjects.forEach(sub => {
            // Separar conteúdos por tipo: base e faculdade
    ...
    // Adicionar eventos das engrenagens dos períodos
...
function loadUserProfile() {
    ...
    // Atualizar nome na tela de perfil
...
function updateProfileStats() {
    ...
    const courseKey = currentUserData?.course?.toLowerCase();
    if (courseKey && coursesData[courseKey]) {
        coursesData[courseKey].forEach(period => {
            disciplinasCount += period.subjects.length;
        });
    }
...
function setupNavigation() {
    ...
    sidebarIcons.forEach(icon => {
        icon.addEventListener('click', function() {
            ...
            const id = this.id;
            if (id === 'btnHome') openScreen('tela-home');
            else if (id === 'btnTrilhas') openScreen('tela-trilhas');
            else if (id === 'btnMenu') openScreen('tela-menu');
            else if (id === 'btnConfig') openScreen('tela-config');
            else if (id === 'profileSettingsBtn') {
                openScreen('tela-perfil');
                loadUserProfile();
            }
        });
    });
...
// ==========================================
// PAINEL DE CONFIGURAÇÕES RÁPIDAS (ENGRENAGEM SUPERIOR)
// ==========================================
...
function initSettingsPanel() {
    ...
    function updateStats() {
        ...
        for (let course in coursesData) {
            coursesData[course].forEach(period => { totalDisciplinas += period.subjects.length; });
        }
    ...
    function updateCourseSelect() {
        ...
        if (courseSelect) {
            ...
            else if (courseKeys.length > 0) renderCurriculum(courseKeys[0]);
        }
    }
    
    function openPanel() { panel.classList.add('open'); overlay.classList.add('show'); updateStats(); updateCoursesList(); }
    ...
    document.getElementById('refreshDataBtn')?.addEventListener('click', () => { showToast('🔄 Dados sincronizados!', 'success'); const c = document.getElementById('courseSelect')?.value; if (c) renderCurriculum(c); updateStats(); });
...
// ==========================================
// EDITAR PERÍODO (ENGRENAGEM NOS PERÍODOS)
// ==========================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (courseSelect) {
        const courseKeys = Object.keys(coursesData);
        courseSelect.innerHTML = courseKeys.map(key => `<option value="${key}">${key.toUpperCase()}</option>`).join('');
        renderCurriculum(courseSelect.value);
        courseSelect.addEventListener('change', (e) => renderCurriculum(e.target.value));
    }
    ...
    async function carregarLivrosDoCurso(nomeCurso) {
        const container = document.getElementById('booksContainer');
        if (!container) return;

        try {
            // Busca na API do Google Books
            const response = await fetch(`https://www.googleapis.com/books/v1/volumes?q=${encodeURIComponent(nomeCurso)}&maxResults=4`);
            ...
            if (data.items) {
                data.items.forEach(item => {
                    ...
                    const capa = info.imageLinks ? info.imageLinks.thumbnail : 'https://via.placeholder.com/128x193?text=Sem+Capa';
                    const titulo = info.title;
                    const link = info.infoLink;

                    const cardHtml = `
                    <a href="${link}" target="_blank" style="text-decoration: none; color: inherit; text-align: center;">
                        <img src="${capa}" alt="${titulo}" style="width: 100%; height: 160px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                        <p style="font-size: 0.85rem; font-weight: 600; margin-top: 8px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">${titulo}</p>
                    </a>
                `;
    ...
    // Executar ao carregar a página (substitua 'Biomedicina' pelo curso salvo do usuário)
    const usuarioSalvo = JSON.parse(localStorage.getItem('currentUser') || '{}');
    const cursoAtual = usuarioSalvo.course || 'Medicina';
    carregarLivrosDoCurso(cursoAtual);
    function adicionarAoGoogleAgenda(titulo, descricao, dataInicio, dataFim) {
        // Formata datas para o formato aceito pelo Google Calendar API URL
    ...
    async function perguntarIA() {
        ...
        output.innerHTML = '<em>Pensando na resposta...</em>';
        input.value = '';

        // Aqui você pode integrar com a API Key da OpenAI ou Google Gemini!
        // Exemplo de integração com API Gemini/OpenAI ou simulação inteligente imediata:
        setTimeout(() => {
            output.innerHTML = `<strong>Tutor IA:</strong> Sobre "${pergunta}": Este é um conceito fundamental no seu curso. Lembre-se de consultar as referências bibliográficas na sua Trilha de Estudos para aprofundar!`;
        }, 1000);
    }
    ...
    // API 1: Google Books (Busca capas de livros)
    window.carregarLivrosDoCurso = async function (nomeCurso) {
        ...
        // Livros padrão de reserva (para a tela NUNCA ficar vazia em caso de Erro 429 do Google)
        const livrosReserva = [
        ...
        try {
            ...
            // Se a API estourar o limite (429), exibe os livros de reserva automaticamente
            renderizar(livrosReserva);
        }
    };

    // API 2: Tutor IA (Perguntas)
    ...
    // API 3: Agendar Lembrete no Google Agenda
    ...
    // ========================================================
    // 2. INICIALIZAÇÃO DA PÁGINA E NAVEGAÇÃO
    // ========================================================
    document.addEventListener('DOMContentLoaded', () => {
        // Tenta carregar dados do usuário se a função existir
        if (typeof window.carregarDadosDoUsuario === 'function') {
            window.carregarDadosDoUsuario();
        }

        // Configuração de troca de telas
        const screens = document.querySelectorAll('.screen');
        const navBtns = {
            'btnHome': 'tela-home',
        ...
        // Dispara a busca inicial de livros
        window.carregarLivrosDoCurso('Biomedicina');
    });
});